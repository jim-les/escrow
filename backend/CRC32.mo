...
// this module provides a function to calculate the CRC-32 checksum of a byte array
// the algorithm is based on the CRC-32 algorithm used in Ethernet and other standards
// see https://en.wikipedia.org/wiki/Cyclic_redundancy_check#CRC-32_algorithm
// this will help us to verify the integrity of the data we receive from the network
module {

// crc32Table is a precomputed table of 256 32-bit values, used to calculate the CRC-32 checksum
